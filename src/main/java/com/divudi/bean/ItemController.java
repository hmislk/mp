...
public class ItemController implements Serializable {
    ...
    public List<Item> completeAmpItem(String query) {
        ...
        if (query == null) {
            ...
            sql = "select c from Item c where c.retired=false and (type(c)= :amp) and (upper(c.name) like :str or upper(c.code) like :str or upper(c.barcode) like :str ) order by c.name";
            //System.out.println(sql);
            tmpMap.put("amp", Amp.class);
            //  tmpMap.put("ampp", Ampp.class);

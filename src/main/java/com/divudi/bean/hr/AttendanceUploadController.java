    ...
    public void uploadAttendance() {
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Map m = new HashMap();
                m.put("d", strCat);
                String sql = "select s from Staff s where s.retired=false and s.code=:d";
...
//21/12/2013 15:17:22 dd/MM/yyyy                         
                        ...
                        if (rffr == null) {
                            ...
                            //////////////////////////
                            ffrv.setStaffShift(searchStaffShift(ffrv));
                            ///////////////////////////
...
//                    System.err.println("Staff : " + s);
    ...
    public StaffShift searchStaffShift(FingerPrintRecord r) {
        ...
        sql = "Select ss from StaffShift ss where ss.retired=false and ss.staff=:s and "

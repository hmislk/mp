...
public class ReportController implements Serializable {
    ...
    private void findPharmacySale() {
        pharmacySale = new ArrayList<>();
        pharmacyTotal = 0;
    ...
    private List<Department> findDepartmentsOfLoggedInstitution() {
        ...
        temMap.put("ret", true);
        temMap.put("ins", getSessionController().getInstitution());
        List<Department> tmp = getDepartmentFacade().findBySQL(sql, temMap);
        return tmp;
    }
    ...
    private List<Category> findCategories() {
        ...
        sql = "select c "
                ...
                + " order by c.name";
        temMap.put("ret", true);
        List<Category> tmp = getCategoryFacade().findBySQL(sql, temMap);
        return tmp;
...
//    }
    ...
    public void calculateDailyCashForInstitutionDepartmentReport() {

        dailyCash = new ArrayList<>();
        List<Category> categories = findCategories();

        for (Department d : findDepartmentsOfLoggedInstitution()) {
